...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form class="form-horizontal" action="fcataddexec.php?id=<?php echo$_GET['fcid'];?>&act=<?php echo$_GET['action'];?>" method="post">
        <div class="form-group">
    <label class="control-label col-sm-2" for="name">Name:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="name"  placeholder="<?php if(isset($_GET['action'])&&$_GET['action']=='Update'){echo $_GET['cname'];}else{echo'Enter Category name';} ?>">
    </div>
  </div>
 <div class="form-group">
